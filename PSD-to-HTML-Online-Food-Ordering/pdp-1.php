			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						  <img src="images/dish-1.png" loading="lazy" />
					</div>
					<div class="details col-md-6">
						<h3 class="product-title">Whooper(Hamburger)</h3>
						<div class="stars">
						...
						<h4 class="price">Price: <span>&#8377;245</span></h4>
						<p class="vote"><strong>98%</strong> of buyers enjoyed this product! <strong>(243 votes)</strong></p>
						<div class="action">

			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						  <img src="images/home-img-3.png" loading="lazy" />
					</div>
					<div class="details col-md-6">
						<h3 class="product-title">ENJOY YOUR PIZZA IN TOWN</h3>
						<div class="stars">
						...
						<h4 class="price">Price: <span>&#8377;299</span></h4>
						<p class="vote"><strong>89%</strong> of buyers enjoyed this product! <strong>(78 votes)</strong></p>
						<div class="action">

			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						  <img src="images/home-img-2.png" loading="lazy" />
					</div>
					<div class="details col-md-6">
						<h3 class="product-title">ENJOY YOUR FRIED CHICKEN IN TOWN.</h3>
						<div class="stars">
						...
						<h4 class="price">Price: <span>&#8377;599</span></h4>
						<p class="vote"><strong>96%</strong> of buyers enjoyed this product! <strong>(122 votes)</strong></p>
						<div class="action">
							<a class="add-to-cart btn btn-default" href="Order.php">Order Now</a>
						</div>
					</div>
				</div>
			</div>

			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						  <img src="images/menu-8.jpg" loading="lazy" />
					</div>
					<div class="details col-md-6">
						<h3 class="product-title">Açaí Na Tigela</h3>
						<div class="stars">
						...
						<h4 class="price">Price: <span>&#8377;700</span></h4>
						<p class="vote"><strong>99%</strong> of buyers enjoyed this product! <strong>(650 votes)</strong></p>
						<div class="action">

			...
			<div class="container-fliud">
				<div class="wrapper row">
					<div class="preview col-md-6">
						  <img src="images/dish-6.png" loading="lazy" />
					</div>
					<div class="details col-md-6">
						<h3 class="product-title">Chicken Legs</h3>
						<div class="stars">
						...
						<h4 class="price">Price: <span>&#8377;389</span></h4>
						<p class="vote"><strong>93%</strong> of buyers enjoyed this product! <strong>(267 votes)</strong></p>
						<div class="action">
